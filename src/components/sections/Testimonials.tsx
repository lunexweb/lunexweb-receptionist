...
const testimonials = [
  {
    ...
    content: "Lunexweb transformed our online presence completely. Our website now generates consistent leads and our Google Ads ROI has tripled. Highly recommended!",
    rating: 5,
  },
  {
    name: "Nomsa Dlamini",
