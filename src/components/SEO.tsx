...
const SEO = ({
  ...
  description = "Lunexweb is a digital agency in Johannesburg offering website development, Google Ads management, and SEO services. Transform your business online.",
  keywords = "web development johannesburg, google ads south africa, seo services kempton park, digital marketing agency",
  canonical,
  ogImage,
  ogType = "website",
  noindex = false,
