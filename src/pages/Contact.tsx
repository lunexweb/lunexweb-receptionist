...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formDataToSend.append("access_key", "9174a541-881f-4a5d-b420-eb2d14d16d80");
      ...
      formDataToSend.append("from_name", "Lunexweb Contact Form");
      formDataToSend.append("botcheck", formData.botcheck); // Honeypot field
      ...
      if (data.success) {
        ...
        setFormData({ name: "", email: "", phone: "", service: "", message: "", botcheck: "" });
      } else {
  ...
  return (
    <Layout>
      <SEO
        ...
        keywords="contact lunexweb, free consultation johannesburg, web development quote, digital marketing consultation south africa, lunexweb contact"
        canonical="/contact"
        ogImage={heroImage}
      />
