...
const Packages = () => {
  return (
    <Layout>
      <SEO
        title="Pricing & Packages | Website & Marketing Packages - Lunexweb"
        description="Transparent pricing for website development, maintenance, Google Ads, and SEO packages. Starting from R4,999 for websites. No hidden fees, flexible options, payment plans available. All packages include free consultation."
        keywords="website pricing johannesburg, web development packages, website maintenance packages, google ads pricing, seo packages south africa, digital marketing pricing"
        canonical="/packages"
        ogImage={heroImage}
      />
      ...
      <HeroSection
        title="Website & Marketing Packages - Transparent Pricing Johannesburg"
        ...
        backgroundImageAlt="Lunexweb Pricing and Packages - Transparent pricing for website development and digital marketing"
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <span className="text-secondary font-semibold uppercase tracking-wider text-sm">Marketing Packages</span>
            <h2 className="text-3xl md:text-4xl font-serif font-bold mt-4 mb-6">
              Digital Marketing Packages
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Ongoing marketing services to grow your online presence.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {adPackages.map((pkg, index) => (
              <div
                key={index}
                className="bg-card rounded-xl p-8 card-shadow hover:card-shadow-elevated transition-all flex flex-col"
              >
                <div className="text-center mb-8">
                  <h3 className="font-serif font-bold text-xl mb-4">{pkg.name}</h3>
                  <div className="flex items-baseline justify-center gap-1">
