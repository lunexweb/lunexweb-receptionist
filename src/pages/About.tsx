          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
            <div>
              ...
              <div className="space-y-3 sm:space-y-4 text-muted-foreground text-sm sm:text-base">
                ...
                <p>
                  Our team combines technical expertise with creative thinking to deliver websites that don't just look good—they generate real results. We believe every business, regardless of size, deserves access to world-class digital solutions.
                </p>
                <p>
