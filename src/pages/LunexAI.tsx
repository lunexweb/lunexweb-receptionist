...
const LunexAI = () => {
  return (
    <Layout>
      <SEO
        title="Lunex AI | AI Receptionist - Never Miss Another Customer Call"
        description="AI-powered voice agent that answers calls 24/7 and qualifies leads. Trusted by 100+ South African businesses. Setup in 30 minutes. Starting from R1,499/month."
        keywords="ai receptionist south africa, ai phone answering service, automated call handling, virtual receptionist johannesburg, ai voice agent, call answering service south africa"
        canonical="/lunex-ai"
      ...
      <StructuredData
        ...
        data={{
          ...
          description: "AI-powered voice agent that answers calls 24/7 and qualifies leads for businesses.",
          offers: {
            "@type": "Offer",
            priceCurrency: "ZAR",
            price: "1999",
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
            <div className="text-primary-foreground">
              <div className="inline-flex items-center gap-2 bg-white/10 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full mb-4 sm:mb-6">
                ...
                <span className="text-xs sm:text-sm font-medium">AI-Powered Voice Agents</span>
              </div>
              
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 leading-tight font-sans">
                AI Receptionist South Africa - Never Miss Another Customer Call
              </h1>
              
              <p className="text-base sm:text-lg md:text-xl text-primary-foreground/90 mb-6 sm:mb-8 leading-relaxed">
                AI receptionist that answers 24/7 and qualifies leads while you focus on your business
              </p>
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 mb-6 sm:mb-8">
                <Button size="xl" className="w-full sm:w-auto bg-secondary hover:bg-secondary/90 text-secondary-foreground font-semibold text-base sm:text-lg px-6 sm:px-8 py-5 sm:py-6 shadow-lg hover:shadow-xl transition-all touch-manipulation">
                  Get Your AI Receptionist <ArrowRight className="ml-2 w-4 h-4 sm:w-5 sm:h-5" />
                </Button>
              ...
              <div className="relative">
                ...
                <div className="absolute right-0 top-20 bg-card rounded-2xl p-6 shadow-2xl w-64 transform rotate-3 animate-fade-in" style={{ animationDelay: '0.2s' }}>
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <p className="font-semibold text-lunex-text">AI Answered</p>
                ...
                <div className="mx-auto w-72 h-[500px] bg-gradient-to-b from-gray-800 to-gray-900 rounded-[3rem] p-2 shadow-2xl animate-fade-in" style={{ animationDelay: '0.4s' }}>
                  <div className="w-full h-full bg-white rounded-[2.5rem] p-4 flex flex-col">
                    <div className="flex-1 flex flex-col items-center justify-center text-center min-h-0">
                      ...
                      <h3 className="font-bold text-foreground text-base mb-1">AI Receptionist Active</h3>
                      <p className="text-muted-foreground text-xs mb-3">Handling incoming call...</p>
      ...
      <section id="how-it-works" className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Answers every call professionally and captures lead details. A powerful tool that supports your business and ensures no customer call goes unanswered.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            ...
            <div className="text-center relative">
              ...
              <h3 className="text-xl font-bold text-foreground mb-2">AI Answers Instantly</h3>
              <p className="text-muted-foreground">Professional AI greeting, asks questions, captures all details</p>
            </div>
      ...
      <section id="features" className="py-20 bg-muted">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: Clock, title: "24/7 Availability", desc: "Never miss calls during nights, weekends, or holidays. Your AI works around the clock." },
              ...
              { icon: Users, title: "Lead Capture", desc: "Gets name, phone number, service needed, address, and urgency level automatically." },
              { icon: Bell, title: "Instant Notifications", desc: "Real-time email alerts the moment a call ends. Never wait to follow up." },
              { icon: Mic, title: "Call Recording", desc: "Every conversation recorded and transcribed. Listen back anytime." },
            ].map((feature, index) => (
            ...
            <Card className="border-0 shadow-2xl bg-card overflow-hidden flex flex-col h-full">
              ...
              <CardContent className="p-8 flex flex-col flex-grow">
                <div className="text-center mb-8">
                  ...
                  <p className="text-muted-foreground">Setup Fee: R5,499 (once-off)</p>
                ...
                <div className="mt-auto">
                  <Button size="lg" className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-semibold text-lg py-6">
                    Get Your AI Receptionist <ArrowRight className="ml-2" />
                  </Button>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {[
              ...
              },
              {
                ...
                quote: "Best investment I've made for my business. The AI sounds professional, captures all the details, and my customers don't even realize it's not a person.",
              },
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto">
            <Accordion type="single" collapsible className="space-y-4">
              {[
                { q: "How does the AI sound?", a: "Professional and natural. Customers typically don't realize they're speaking with AI. You can hear a demo above." },
                { q: "What if the AI can't handle a call?", a: "The AI captures all details and notifies you immediately. You can call back within minutes while the lead is still warm." },
                ...
                { q: "How long does setup take?", a: "30 minutes. We'll train the AI on your business, configure your number, and test everything with you." },
